...
Run the model.py file to train the model and then implement it. This file doesn't contain the data cleaning process as it needs manual imput and understanding. Data cleaning process is explained in detail in the report.
